...
namespace QL_KHACHSAN
{
    public partial class FDichvu : Form
    {
        ...
        private void txtIDDichvu_TextChanged(object sender, EventArgs e)
        {
        ...
        private void FDichvu_Load_1(object sender, EventArgs e)
        {

        }

        private void FDichvu_Load_2(object sender, EventArgs e)
        {
            dsDichVu = ctrlDichVu.findall();
            foreach (CDichvu s in dsDichVu)
            {
        ...
        {
            {
                try
                {
                    ...
                    dsDichVu = ctrlDichVu.findCriteria(dkFind);

                    lsvDanhSachDichVu.Items.Clear();
                    foreach (CDichvu s in dsDichVu)
                    {

                        string[] obj = { s.DichVuID1.ToString(), s.TenDichVu1, s.GiaTien1.ToString() };
                        ListViewItem item = new ListViewItem(obj);
                        lsvDanhSachDichVu.Items.Add(item);
                    }
                }
